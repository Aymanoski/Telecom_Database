<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsagePlanMonth.aspx.cs" Inherits="WebApplication1.UsagePlanMonth" %>

<!DOCTYPE html>
<html>
<head runat="server">
    <title>Usage Plan - Current Month</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        <div>
            <h1>Usage Plan - Current Month</h1>
            ...
            <!-- Submit Button -->
            <asp:Button ID="btnSubmit" runat="server" CssClass="aspNet-Button" Text="Get Current Month Usage" OnClick="btnSubmit_Click" />
            <br />
            <asp:Label ID="Label1" runat="server" Text=""></asp:Label>
            <br />

            <!-- Grid to Display Results -->
            <asp:GridView ID="gvUsagePlan" runat="server" CssClass="grid-view" AutoGenerateColumns="True" />
