...
{
    public partial class physicalVoucher : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if(dt.Rows.Count == 0 || dt.Columns.Count == 0)
                ...
                Label2.Text = "Not INformation Available Available";
            }
                    else
            {
                // Bind data to GridView and clear Label2
                gphysicalVoucher.DataSource = dt;
                gphysicalVoucher.DataBind();
                Label2.Text = "";
            }
        }
